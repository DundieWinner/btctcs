...
export function ragnarProcessor(rangeData: (GoogleSheetData | null)[]): GoogleSheetData {
  ...
  for (let i = 0; i < maxRows; i++) {
    ...
    const label = labelRow && labelRow[labelsRange.headers[0]] ? String(labelRow[labelsRange.headers[0]]).trim() : '';
    const value = valueRow && valueRow[valuesRange.headers[0]] ? String(valueRow[valuesRange.headers[0]]).trim() : '';
      ...
      extractions: [
        {
          id: "ragnar",
          title: "Ragnar Stats",
          description: "Data provided by <a href='https://x.com/RoaringRagnar' target='_blank' rel='noopener noreferrer'>@RoaringRagnar</a>'s open-source <a href='https://docs.google.com/spreadsheets/d/1hzlHsDwhcwRr3cPrZZBlavMU3mFda1CX6gVHJvURhzE/edit?gid=963629592#gid=963629592' target='_blank' rel='noopener noreferrer'>Google Sheet</a>",
