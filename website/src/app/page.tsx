      ...
      <div className="max-w-screen-6xl mx-auto px-8 flex-1">
        ...
        <header className="text-center mb-16 pt-8">
          ...
          <p className="text-xl text-gray-300 max-w-6xl mx-auto">
            Tracking and charting the Bitcoin treasury companies taking the world by storm 🌪️
          </p>
        </header>
        ...
        <div className="max-w-4xl mb-12">
          <p className="text-lg text-gray-300 leading-relaxed">
            These dashboards are an open project with volunteer curators helping keep the company data up to date. 
            Interested volunteers can contact me via DM on X{" "}
            <a 
        ...
        {/* Companies List */}
        <div className="max-w-md md:max-w-2xl lg:max-w-4xl pb-8">
